...
capitais_estados = ["Porto Velho", "Manaus", "Rio Branco", "Campo Grande", "Macapá", "Boa Vista", "Cuiabá", "Palmas", "São Paulo", "Teresina", "Rio de Janeiro", "Belém", "Goiânia", "Salvador", "Florianópolis", "São Luís", "Maceió", "Porto Alegre", "Curitiba", "Belo Horizonte", "Fortaleza", "Recife", "João Pessoa", "Aracaju", "Natal", "Vitória"]
...
UF_TO_ANIMATE = "DF"
UF_NAME = "Distrito Federal"

UF_TO_ANIMATE = UF_TO_ANIMATE.replace(" ", "")
print(f"Fazendo para {UF_TO_ANIMATE}")


jsonPath = f"./Analise_covid/Data/geojson/{UF_TO_ANIMATE}.json"
